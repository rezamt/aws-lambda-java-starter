...
import au.com.vodafone.model.ServerlessResponse;
import com.amazonaws.services.lambda.runtime.Context;
import com.amazonaws.services.lambda.runtime.LambdaLogger;
import com.amazonaws.services.lambda.runtime.RequestHandler;

// Vodafone Company
import au.com.vodafone.model.ServerlessRequest;
...
public class LambdaHandler implements RequestHandler<ServerlessRequest, ServerlessResponse> {
   ...
   * @Configure: au.com.vodafone.LambdaHandler::handleRequest (package.class::method)
   */
